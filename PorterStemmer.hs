-- The following Porter Stemmer algorithm was developed by Martin Porter and implemented in Haskell by Dmitry Antonyuk
-- Note that the author has stated explicitly that "all these encodings of the algorithm can be used free of charge for any purpose."
...
stemWords :: [String] -> [String]
stemWords words = map stem words
